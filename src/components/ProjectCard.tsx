...
const ProjectCard: React.FC<Props> = ({title, description, link, image, rmm, status}) => {
    return (
    <div className="p-6 bg-orange-100 dark:bg-dark-bg-secondary text-zinc-900 transition-colors duration-500 dark:text-slate-50 flex flex-col-reverse sm:flex-row-reverse mx-auto rounded-md justify-between sm:w-1/2 mt-8">
    <div className="flex flex-col-reverse sm:flex-row-reverse sm:justify-end items-center">
        ...
        <a href={link} ><img src={image} alt=""  className="w-32 h-32 border-orange-500 dark:border-dark-accent border-4"/></a>
    </div>
