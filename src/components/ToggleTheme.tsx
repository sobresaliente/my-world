...
export const ToggleTheme = () => {
    ...
    return (isMounted ? <div className="inline-flex items-center justify-between p-[2px] rounded-3xl bg-orange-300 dark:bg-zinc-600 w-16 opacity-60 sm:mt-0 absolute right-3 top-0 sm:relative max-h-10">{themes.map((t,) => {
        ...
        : <div className="inline-flex items-center p-[1px] rounded-3xl bg-orange-300 text-orange-300 dark:bg-zinc-600  dark:text-zinc-600 w-16 opacity-0 sm:mt-0 top-0 max-h-10">
